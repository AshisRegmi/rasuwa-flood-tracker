...
const STRINGS = {
  en: {
    ...
    identifiedLead: 'Official information about identified victims is published in Nepal Police notices.',
    totalLost: 'lost',
    totalFound: 'found',
    totalDead: 'deceased',
    totalRescued: 'rescued',
    statsNote: 'Official totals — the lists below show only partially synced data.',
    ...
    foreignTitle: 'Foreign nationals',
    foreignLead: 'Foreign-national records are matched from nationality keyword searches of official reports. The authoritative country-wise list is on NDRRMA.',
    foreignLinksLead: 'Official sources:',
    foreignFilterAll: 'All',
    foreignFilterFound: 'Rescued',
    foreignFilterLost: 'Missing',
  },
  ne: {
    appName: 'सहारा',
    ...
    identifiedLead: 'पहिचान भएका मृतकको आधिकारिक जानकारी नेपाल प्रहरीका सूचनाहरूमा प्रकाशित हुन्छ।',
    totalLost: 'बेपत्ता',
    totalFound: 'भेटिएका',
    totalDead: 'मृतक',
    totalRescued: 'उद्धार',
    statsNote: 'आधिकारिक तथ्याङ्क — तलका सूचीहरूमा आंशिक डेटा मात्र देखिन्छ।',
    ...
    foreignTitle: 'विदेशी नागरिक',
    foreignLead: 'विदेशी नागरिकहरूको विवरण राष्ट्रियता कीवर्ड खोजबाट जोडिएको छ — आधिकारिक देशअनुसार सूची NDRRMA मा छ।',
    foreignLinksLead: 'आधिकारिक स्रोतहरू:',
    foreignFilterAll: 'सबै',
    foreignFilterFound: 'उद्धार गरिएका',
    foreignFilterLost: 'बेपत्ता',
  },
};
